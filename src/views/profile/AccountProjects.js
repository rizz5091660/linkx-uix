...
import EditAccountProjectModel from "../offer/EditAccountProjectModel";
          ...
          {projectArr.map((prj, idx) => (
            <Row key={idx} className="p-4">
              <Col md="12">
                <Row>
                  <Col>
                    <div className="blog-comments__avatar mr-3" style={{ float: "left", paddingBottom: "10px" }}>
                ...
                <Row onClick={this.openProjectPage.bind(this,prj.url)} style={{cursor: "pointer"}}>
                  <Col>
                    <div style={{ float: "left" }}>
                    ...
                    <div className="projectStats" style={{ height: "90px", backgroundColor: "#f2f3f5", padding: "5px", float: "left" }}>
                      <div style={{ float: "left", padding:"0 5px"}}>
                        <img src={prj.socmed.avatarFullPath} width="40px" />
                      </div>
                      <div style={{ float: "left" }}>
                        <span style={{ color: "#868e96", fontWeight: "400", fontSize: "13px" }}>{prj.projectTitle}</span><br />
