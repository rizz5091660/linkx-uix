...
class OfferDetail extends React.Component {
    ...
    apply(){
        OfferService.apply(this.state.offerId,this.props.accountId)
        .then((data) => { 
    ...
    openApplyModal(offerId,offerName,orgName) {
        this.setState({
                    ...
                    <Row>
                        <Col>
                            <div className="border-bottom" style={{ padding: "1rem" }} >
                                ...
                                <div style={{ paddingleft: "10rem", paddingTop: "4rem" }}> <span style={{ fontSize: "20px" }} >Offer Description</span></div>
